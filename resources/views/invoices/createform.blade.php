...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2 form-block">
            <h2 style="text-align: right;"><a href="/invoices" class="btn btn-sm btn-danger" style="font-weight: bold;">-back to invoices</a></h2>
            <h1>Invoice</h1>
            @if(session()->has('message'))
             ...
             @endif
            <form role="form" method="post" action="/invoices" enctype="multipart/form-data">
